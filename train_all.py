...
from BirdNets import BirdNetComplexV1, BirdNetComplexV2, BirdNetComplexV3, BirdNetSimple, BirdNetSimpleV2
...
if __name__ == '__main__':
    ...
    net_names = ['BirdNetComplexV1', 'BirdNetComplexV2', 'BirdNetComplexV3', 'BirdNetSimple', 'BirdNetSimpleV2']
    for i, net in enumerate([BirdNetComplexV1(), BirdNetComplexV2(), BirdNetComplexV3(), BirdNetSimple(), BirdNetSimpleV2()]):
        ...
        for epoch in range(EPOCHS):
            ...
            if val_tp_tn > best_val_acc:
                ...
                current_best = 'current_best_for_' + PATH
        ...
        with open("results.txt", "a") as f:
            f.write("After {} epochs: \n Train accuracy: {:.4f} \n Val accuracy: {:.4f}\n".format(EPOCHS, history["train_acc"][-1], history["val_acc"][-1]))
